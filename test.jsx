...
const SingUp = () => {
      ...
      const handleSubmit = async (e) => {
            ...
            try {
                  ...
                  router.push('/pages/Account') // Redirect to '/pages/Account'
            } catch (e) {
                  setError(e.message)
            ...
            <div>
                  <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20'>
                        ...
                        <form onSubmit={handleSubmit}>
                              ...
                              <button className='w-full my-2 p-3 bg-button text-btnText rounded-xl shadow-xl'>Sing up</button>
                        </form>

                        <p className='text-center mt-3 '>Already Have Account ? <Link className='font-bold text-accent' href="/pages/SingIn">Sing in!</Link></p>
                  </div>
            </div>
      )
}
